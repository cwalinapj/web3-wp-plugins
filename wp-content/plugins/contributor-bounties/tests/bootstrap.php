...
function _contributor_bounties_load_plugin() {
    require dirname(__FILE__) . '/../contributor-bounties.php';
}

tests_add_filter('muplugins_loaded', '_contributor_bounties_load_plugin');
